...
<article class="our-rooms">
  <header>
    <h1 class="base yellow">Stay in our modern rooms </h1>
    <h2 class="undertitle yellow">With the sound of the ocean nearby </h2>
  </header>
  <div class="wrapper">
    ...
    <section class="right-6">
      <p class="base">
        Olá Onda Guesthouse is a typical Portuguese villa, renovated so it offers all you may need on your holiday. The house is surrounded by a big garden with different plants, cacti and fruit trees. There is an open air kitchen and free use of the wifi.
      </p>
...
<article class="why">
  <header>
    <h1 class="base green">Why would you stay with us?</h1>
    <h2 class="undertitle green">Reasons to stay at Olá Onda guest house</h2>
  </header>
    ...
    <figure class="sea-the-ocean">
      <div class="content">
        <h2 class="undertitle sea-the-ocean">
          right after you wake up, and check out the stars in the quiet nights from your own balcony or bed
        </h2>
      </div>
    </figure>
  </section>
...
<article class="surf-in-ericeira">
    ...
    <header class="image-box">
      <section class="content">
        <h1 class="white">Surf &amp; Ericeira</h1>
        <h2 class="white">Ericeira is the first World Surf Reserve in Europe</h2>
      </section>
    </header>
    <p class="full-width">
      Part of the beautiful coastline of Ericeira, and therefore the surf spots, is protected area being Europe’s only World Surf Reserve. The coast is littered with golden sand beaches, stunning cliffs and great waves for everyone; beginners, intermediates and advanced surfers. Next to that, the town of Ericeira is a most pleasant place to stay. You’ll find tiny blue and white houses, small cobblestone streets, sunny terraces and friendly people. All a stone’s throw away from the beautiful city of Lisbon, Sintra and Cascais. Read more on where to surf in our Ericeira Surf Spot Guide (link)
    <p>
